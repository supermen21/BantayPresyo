      ...
      <div class="col-md-8">
        <div class="row">
          ...
          <div class="col-xl-3 col-md-7 col-6 my-1">
            <h5 style="font-family:'Roboto'!important;"><?=$rowUserInfo['LNAME'] . ', ' . $rowUserInfo['FNAME'] . ' ' . $rowUserInfo['MNAME'];?></h5>
          </div>
          ...
          <div class="col-xl-3 col-md-7 col-6 my-1">
            <h5 style="font-family:'Roboto'!important;"><?php echo $rowUserInfo['ACCESSLEVEL'];?></h5>
          </div>
          ...
          <div class="col-xl-3 col-md-7 col-6 my-1">
            <h5 style="font-family:'Roboto'!important;"><?php echo $rowUserInfo['EMAILADD'];?></h5>
          </div>
          ...
          <div class="col-xl-3 col-md-7 col-6 my-1">
            <h5 style="font-family:'Roboto'!important;"><?php echo $rowUserInfo['OFFICE'];?></h5>
          </div>
