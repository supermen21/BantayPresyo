...
if(isset($_POST['submit'])) {
    ...
    for($k=0; $k<$count_row; $k++){
            ...
            // if(!empty($respone)){
               ...
               $dbConn->query('INSERT INTO tbl_nw_prices (PRICES_ID, DATE, MARKET_CODE, COMMODITY_CODE, CATEGORY_CODE, RESP_1,RESP_2,RESP_3,RESP_4,RESP_5, ENCODER) VALUES ("' . $prices_id . '","' . $date . '", "' . $market . '", "' . $comm . '", "' . $cat . '", "' . $respone . '", "' . $resptwo . '", "' . $resptri . '", "' . $resppor . '", "' . $respfive . '", "' . $encoder . '") ');
            // }
            echo "<script>window.location.href='tbl_encode_prices.php';</script>";
}
}
?>
<form method="post">
                ...
                <div style="font-size: 1rem;">
                    <div class="form-row mt-3 border">
                        ...
                        <div class="col-lg-3 p-2">
                            <input type="date" class="form-control text-xs" name="txtDate"/>
                        </div>
                        ...
                        <div class="col-lg-3 p-2">
                          <?php if($rowUserInfo['ASSIGNED_MARKET']=="Marikina Market"){?>
                            <input type="text" class="form-control text-xs" name="txtMarket" value="Marikina Market" disabled/> Marikina
                          <?php } ?>
                        </div>
                    </div>
                </div>
