...
$encoder = $rowUserInfo['USERID'];
   $get_newprices = $dbConn->query("SELECT * FROM tbl_nw_prices WHERE `DATE` = '$mdate' AND STATUS is NULL");
 ?>
        ...
        <div class="form-row">
            <div class="col-lg-12">
                ...
                <div class="form-row mt-2">
                    <div class="col-lg-12">
                    <!-- Data Table -->
                        <!-- <table id="" class="table table-striped table-bordered table-responsive dataTable no-footer text-xs"> -->
